...
implements IPerson {
    ...
    public EfficientPerson(String lastName, String firstName, int birthYear, int birthMonth, int birthDay) {
    ...
    public int getAge(GregorianCalendar date) {
        ...
        if (this.birthDate.get(1) < date.get(1)) {
            ...
            if (this.birthDate.get(2) == date.get(2)) {
                ...
                if (this.birthDate.get(5) - 1 == date.get(5)) {
                    return date.get(1) - this.birthDate.get(1) - 2;
                }
