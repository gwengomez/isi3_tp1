...
public class TortueFlocking extends TortueAutonome{
    ...
    public static int distanceMin = Tortue.rp * 3; //minimal distance between tortue
    public static int visionRange = Tortue.rp * 6;
    public static int visionRadius = 60; //radius (+/- deg) which a turtle can see (between -visionRadius and +visionRadius - giving it a total radius of 2*visionRadius) 
    ...
    public void nextStepFlocking(ArrayList<TortueFlocking> tortues) {
       ArrayList<TortueFlocking> inVisionRange = new ArrayList<>();
       for(TortueFlocking t: tortues) {
           if(t == this) {
               continue;
           }
       ...
       ArrayList<TortueFlocking> inRadiusRange = new ArrayList<>();
       for(TortueFlocking t : inVisionRange) {
       ...
       if(inRadiusRange.isEmpty()) {
           ...
           for(TortueFlocking t : inRadiusRange) {
